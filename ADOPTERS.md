...
| [IBM](https://www.ibm.com.) | kishen.viswanathan@ibm.com | ![internal](https://img.shields.io/badge/-internal-green?style=flat) | Kube-burner is predominantly used in our internal QE tests for every release of OpenShift Container Platform for the PowerPC architecture. The tool is integrated into our comprehensive testing framework to ensure performance consistency and identify regressions during new releases. |
